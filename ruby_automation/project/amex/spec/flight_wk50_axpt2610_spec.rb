...
describe AMEX_Air do
  describe Week_50 do
    describe "Flight: AXPT-2610 - On Air search form, provide users with access to a list of Airports Worldwide" do    
      driver = nil
      page = nil 
      ...
      it "On the Air search page there is a link to Airports below the entry boxes for airport/city." do
        page = FlightSearchPage.new(driver, RSpec.configuration.env)
        page.visit()
        page.airports_worldwide_departure_link.should be_present()
        page.airports_worldwide_arrival_link.should be_present()
      end
       ...
       it "When clicked, an overlay appears that lists cities in alphabetical order along with their airport code.
        ...
        page.should_not be_element_present(page, "airports worldwide overlay title", "css")
        ...
        departure_city_text_value = driver.execute_script("return arguments[0].value" , page.departure_city_textbox(1))
      ...
      it "If the Airport list was accessed by clicking the Airport link below Destination, 
        ...
        page.airports_worldwide_overlay_us_airports_abecedary_letter_link.click()
        page.airports_worldwide_overlay_us_airports_code_link.click()
        arrival_city_text_value = driver.execute_script("return arguments[0].value" , page.arrival_city_textbox(1))
